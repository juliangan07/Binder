...
<nav class="navbar navbar-default navColor" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand titleFont" href="default.html">Binder</a>
    </div>
    ...
    <form class="navbar-form navbar-left">
          <div class="input-group">
              ...
              <div class="input-group-btn">
                <button class="btn btn-default" type="submit" formaction="productlist.html">
    ...
    <div class="collapse navbar-collapse" id="collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="login.html" style="color:#000000" class="btn btn-default btnSignInColor">Sign In</a></li>
      </ul>
    </div>
