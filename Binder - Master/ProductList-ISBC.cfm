...
<CFQUERY NAME="GetRecord" DATASOURCE="ISBC490-SP2017">
     SELECT Books.ISBN, Title, Author,Edition,Class_Code, PRICE, COMMENTS, CONDITION
     FROM Books, Posted
     WHERE Books.ISBN=Posted.ISBN and CLASS_CODE like 'ISBC%';
</CFQUERY>

<div class="content container">
<h2>Search Result: Information Systems</h2>
  <div class="row">
